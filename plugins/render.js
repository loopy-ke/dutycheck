/**
 * CarDuty — Shared page renderer (dev SSR + prod static generation)
 *
...
<head>
  ...
  <link rel="canonical" href="https://carduty.co.ke${canonical}" />
...
function renderCategoryPage(category, catSlug) {
  ...
  return layout({
    title:    `${category} Import Duty Kenya 2025 — CarDuty`,
...
function renderMakePage(category, catSlug, make, makeSlug) {
  ...
  return layout({
    title:    `${make} ${category} Import Duty Kenya 2025 — CarDuty`,
...
function renderModelPage(category, catSlug, make, makeSlug, modelSlug) {
  ...
  return layout({
    title:    `${make} ${m.model} Import Duty Kenya 2025 — CarDuty`,
...
function renderYearPage(category, catSlug, make, makeSlug, modelSlug, year) {
  ...
  return layout({
    title:    `${make} ${m.model} ${year} Import Duty Kenya — ${kes(total)} — CarDuty`,
